...
const FEATURES: Record<string, { title: string; desc: string; points: string[] }> = {
  day: {
    title: "오늘 할일",
    desc: "하루 작업을 한 화면에서 다 관리하는 곳. 프로젝트를 전환하며 할일을 체크하고, 일일 퀘스트로 오늘의 핵심 목표를 잡을 수 있어요.",
    points: [
  ...
  calendar: {
    title: "주간 캘린더",
    desc: "3일 단위로 작업 세션을 시각화합니다. 언제, 어떤 앱으로, 얼마나 했는지 — 프로젝트 색상으로 한눈에.",
    points: [
  ...
  pomodoro: {
    title: "포모도로 타이머",
    desc: "25분 집중, 5분 휴식을 반복하는 포모도로로 작업 리듬을 잡습니다. 완료된 세션은 자동으로 오늘의 집중 기록에 쌓이고요.",
    points: [
      "25분 집중 / 5분 휴식 원클릭 전환",
  ...
  stats: {
    title: "데일리 아카이브",
    desc: "날짜별 작업 세션이 타임테이블로 자동 기록됩니다. 과거 날짜를 탐색하며 어떤 하루를 보냈는지 돌아볼 수 있어요.",
    points: [
      "날짜 탐색으로 과거 기록 열람",
  ...
  settings: {
    title: "설정",
    desc: "타임테이블 표시 방식부터 앱 필터까지 원하는 대로 조정할 수 있어요. 자동 추적, 테마, 알림 기능은 추후 업데이트 예정.",
    points: [
  ...
  diary: {
    title: "일기 (모바일)",
    desc: "하단 일기 버튼 하나로 오늘 날짜 제목의 화면이 바로 뜹니다. 기분을 이모지로 고르고, 글 쓰고, 사진도 붙일 수 있어요.",
    points: [
