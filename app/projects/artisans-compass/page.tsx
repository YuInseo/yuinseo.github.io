    ...
    <div className="min-h-screen bg-[#0d0d0f] text-white">
      ...
      <section className="relative overflow-hidden px-6 pb-24 pt-20 text-center">
        ...
        <p className="mb-4 text-sm font-semibold uppercase tracking-widest text-blue-400">
          Desktop Productivity App · Windows
        </p>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-24">
        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          {features.map((f) => (
            <div
              key={f.title}
              className="rounded-2xl border border-white/8 bg-white/4 p-6 transition-colors hover:border-white/15 hover:bg-white/6"
            >
      ...
      <section className="border-y border-white/6 bg-white/2 px-6 py-24">
        <div className="mx-auto max-w-4xl">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            {archiveModes.map((am) => (
              <div key={am.mode} className={`rounded-2xl border p-7 ${am.color}`}>
                <span
          ...
          <div className="rounded-2xl border border-white/8 bg-[#111114] p-6">
            ...
            <div className="space-y-1 text-[10px] text-zinc-600">
              {[
                ...
                { time: "06:00", bars: [] },
                { time: "08:00", bars: [] },
                { time: "10:00", bars: [{ w: "90%", color: "bg-blue-400" }] },
                { time: "12:00", bars: [] },
                { time: "14:00", bars: [] },
                {
                  time: "16:00",
                  bars: [
                    ...
                    { w: "55%", color: "bg-zinc-600" },
                  ],
                },
                { time: "18:00", bars: [] },
                { time: "20:00", bars: [{ w: "40%", color: "bg-blue-600" }] },
                { time: "22:00", bars: [] },
                { time: "00:00", bars: [] },
              ].map((row, idx) => (
                <div key={idx} className="flex items-center gap-3">
                  ...
                  <div className="relative flex-1 space-y-0.5">
                    ...
                    {row.bars.length === 0 && <div className="h-px w-full bg-white/5" />}
                  </div>
                </div>
              ))}
            </div>
